...
namespace AForge.Math.Tests
{
    ...
    public class Matrix3x3Test
    {
        ...
        private readonly Matrix3x3 a1;
        private readonly Matrix3x3 a2;
        ...
        // TODO: Fix this
        //[TestCase( 1, 0, 0, 0, 1, 0, 1, 0, 0, ExpectedResult = typeof( ArgumentException ) )]
        [TestCase(2, 0, 0, 0, 4, 0, 0, 0, 3)]
        [TestCase(1, 4, 2, 2, 2, 1, 2, 1, 1)]
        public void InverseTest(float v00, float v01, float v02, float v10, float v11, float v12, float v20, float v21,
                                float v22)
        {
            Matrix3x3 matrix = new Matrix3x3();
        ...
        private bool ApproximateEquals(Matrix3x3 matrix1, Matrix3x3 matrix2)
        {
            ...
            return (System.Math.Abs(matrix1.V00 - matrix2.V00) <= Epsilon) &&
        ...
        public void AddMatricesTest()
        {
            ...
            Matrix3x3 result = this.a1 + this.a2;
        ...
        public void CreateFromColumnsTest()
        {
            ...
            Assert.Throws<ArgumentException>(() => { matrix.GetColumn(-1); }
                );

            Assert.Throws<ArgumentException>(() => { matrix.GetColumn(3); }
                );
        }
        ...
        public void CreateFromRowsTest()
        {
            ...
            Assert.Throws<ArgumentException>(() => { matrix.GetRow(-1); }
                );

            Assert.Throws<ArgumentException>(() => { matrix.GetRow(3); }
                );
        }
