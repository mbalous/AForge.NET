...
namespace AForge.Math.Geometry.Tests
{
    ...
    {
        private readonly List<IntPoint> pointsList0 = new List<IntPoint>();
        private readonly List<IntPoint> pointsList1 = new List<IntPoint>();
        private readonly List<IntPoint> pointsList2 = new List<IntPoint>();
        private readonly List<IntPoint> pointsList3 = new List<IntPoint>();
        private readonly List<IntPoint> pointsList4 = new List<IntPoint>();
        private readonly List<IntPoint> pointsList5 = new List<IntPoint>();
        private readonly List<IntPoint> pointsList6 = new List<IntPoint>();

        private readonly List<IntPoint> pointsList7 = new List<IntPoint>();
        private readonly List<IntPoint> pointsList8 = new List<IntPoint>();
        private readonly List<IntPoint> pointsList9 = new List<IntPoint>();

        private readonly List<IntPoint> expectedHull8 = new List<IntPoint>();

        private readonly List<List<IntPoint>> pointsLists = new List<List<IntPoint>>();
        private readonly List<List<IntPoint>> expectedHulls = new List<List<IntPoint>>();
        ...
        public void FindHullTest()
        {
            ...
            {
                ComparePointsLists(grahamHull.FindHull(this.pointsLists[i]), this.expectedHulls[i]);
            }
        }
    }
}