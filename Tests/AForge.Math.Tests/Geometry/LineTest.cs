...
namespace AForge.Math.Geometry.Tests
{
    ...
    public class LineTest
    {
        ...
        public void RThetaTest(float x, float y, float theta, float expectedRadius, float expectedSlope,
                               float expectedIntercept)
        {
        ...
        public void IsVerticalTest(float sx, float sy, float ex, float ey, bool expectedResult, float expectedSlope,
                                   float expectedIntercept)
        {
        ...
        public void IsHorizontalTest(float sx, float sy, float ex, float ey, bool expectedResult, float expectedSlope,
                                     float expectedIntercept)
        {
            Line line = Line.FromPoints(new Point(sx, sy), new Point(ex, ey));
        ...
        public void GetAngleBetweenLinesTest(float sx1, float sy1, float ex1, float ey1, float sx2, float sy2, float ex2,
                                             float ey2, float expectedAngle)
        {
        ...
        public void GetIntersectionPointTest(float sx1, float sy1, float ex1, float ey1,
                                             float sx2, float sy2, float ex2, float ey2, float xRet, float yRet,
                                             bool hasResult)
        {
            Line line1 = Line.FromPoints(new Point(sx1, sy1), new Point(ex1, ey1));
            Line line2 = Line.FromPoints(new Point(sx2, sy2), new Point(ex2, ey2));
