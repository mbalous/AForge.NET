...
namespace AForge.Math.Tests
{
    ...
    public class Matrix4x4Test
    {
        ...
        private readonly Matrix4x4 a1;
        private readonly Matrix4x4 a2;
        ...
        public void AddMatricesTest()
        {
            ...
            Matrix4x4 result = this.a1 + this.a2;
        ...
        public void CreateFromColumnsTest()
        {
            ...
            Assert.Throws<ArgumentException>(() => { matrix.GetColumn(4); }
                );
        }
        ...
        public void CreateFromRowsTest()
        {
            ...
            Assert.Throws<ArgumentException>(() => { matrix.GetRow(4); }
                );
        }
