...
namespace AForge.Imaging
{
    ...
    public class UnmanagedImage : IDisposable
    {
        ...
        public static UnmanagedImage FromManagedImage(BitmapData imageData)
        {
            ...
            UnmanagedImage image = new UnmanagedImage(dstImageData, imageData.Width, imageData.Height, imageData.Stride,
                pixelFormat);
        ...
        public byte[] Collect8bppPixelValues(List<IntPoint> points)
        {
            ...
            if ((pixelFormat == PixelFormat.Format16bppGrayScale) || (pixelSize > 4))
            {
                throw new UnsupportedImageFormatException(
                    "Unsupported pixel format of the source image. Use Collect16bppPixelValues() method for it.");
            }
            ...
            if ((x >= 0) && (y >= 0) && (x < width) && (y < height))
            {
                unsafe
                {
                    ...
                    switch (pixelFormat)
                    {
                        ...
                        default:
                            throw new UnsupportedImageFormatException("The pixel format is not supported: " +
                                                                      pixelFormat);
                    }
                }
            }
        ...
        public ushort[] Collect16bppPixelValues(List<IntPoint> points)
        {
            ...
            {
                throw new UnsupportedImageFormatException(
                    "Unsupported pixel format of the source image. Use Collect8bppPixelValues() method for it.");
            }
