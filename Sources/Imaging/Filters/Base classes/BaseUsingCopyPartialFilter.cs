...
namespace AForge.Imaging.Filters
{
    ...
    /// </remarks>
    ///
    public abstract class BaseUsingCopyPartialFilter : IFilter, IInPlaceFilter, IInPlacePartialFilter,
        IFilterInformation
    {
        /// <summary>
        ...
        public UnmanagedImage Apply(UnmanagedImage image)
        {
            ...
            UnmanagedImage dstImage = UnmanagedImage.Create(image.Width, image.Height,
        ...
        public void Apply(UnmanagedImage sourceImage, UnmanagedImage destinationImage)
        {
            ...
            if ((destinationImage.Width != sourceImage.Width) || (destinationImage.Height != sourceImage.Height))
            {
                throw new InvalidImagePropertiesException(
                    "Destination image must have the same width and height as source image.");
            }
