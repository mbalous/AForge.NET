    ...
    public class MaskedFilter : BaseInPlacePartialFilter
    {
        ...
        protected override unsafe void ProcessFilter(UnmanagedImage image, Rectangle rect)
        {
            if (mask != null)
            {
                    ...
                    (image.Height != mask.GetLength(0)))
                {
                    throw new ArgumentException(
                        "Invalid size of mask array. Its size must be the same as the size of the image to mask.");
                }
            ...
            else if (unmanagedMaskImage != null)
            {
                ...
                {
                    throw new ArgumentException(
                        "Invalid size of unmanaged mask image. Its size must be the same as the size of the image to mask.");
                }
            ...
            else if (maskImage != null)
            {
                ...
                {
                    throw new ArgumentException(
                        "Invalid size of mask image. Its size must be the same as the size of the image to mask.");
                }
