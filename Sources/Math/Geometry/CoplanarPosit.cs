...
namespace AForge.Math.Geometry
{
    ...
    public class CoplanarPosit
    {
        ...
        private void POS(Point[] imagePoints, Vector3 eps, out Matrix3x3 rotation1, out Matrix3x3 rotation2,
            out Vector3 translation1, out Vector3 translation2)
        {
            ...
            translation1 = new Vector3(imagePoints[0].X/scale - temp.X, imagePoints[0].Y/scale - temp.Y,
                focalLength/scale);
            ...
            translation2 = new Vector3(imagePoints[0].X/scale - temp.X, imagePoints[0].Y/scale - temp.Y,
                focalLength/scale);
        }
