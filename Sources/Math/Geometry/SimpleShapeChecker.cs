    ...
    public class SimpleShapeChecker
    {
        ...
        public PolygonSubType CheckPolygonSubType(List<IntPoint> corners)
        {
            ...
            else if (corners.Count == 4)
            {
                ...
                float angleBetween1stPair = GeometryTools.GetAngleBetweenLines(corners[0], corners[1], corners[2],
                    corners[3]);
                float angleBetween2ndPair = GeometryTools.GetAngleBetweenLines(corners[1], corners[2], corners[3],
                    corners[0]);
                ...
                if (angleBetween1stPair <= angleError)
                {
                    ...
                    if (angleBetween2ndPair <= angleError)
                    {
                        ...
                        if (Math.Abs(GeometryTools.GetAngleBetweenVectors(corners[1], corners[0], corners[2]) - 90) <=
                            angleError)
                        {
