    ...
    public sealed class LineSegment
    {
                ...
                if (line.Intercept == other.line.Intercept)
                {
                    ...
                    else
                    {
                        ...
                        throw new InvalidOperationException(
                            "Overlapping segments do not have a single intersection point.");
                    }
                }
            }
            else
        ...
        private ProjectionLocation LocateProjection(Point point)
        {
            ...
            */
            ...
            ProjectionLocation result = (numerator < 0)
                ? ProjectionLocation.RayA
                : (numerator > denomenator) ? ProjectionLocation.RayB : ProjectionLocation.SegmentAB;
