...
namespace AForge.Math.Geometry
{
    ...
    public static class PointsCloud
    {
        ...
        /// 
        public static void GetFurthestPointsFromLine(IEnumerable<IntPoint> cloud, IntPoint linePoint1,
            IntPoint linePoint2,
        ...
        ///
        public static IntPoint GetFurthestPointFromLine(IEnumerable<IntPoint> cloud, IntPoint linePoint1,
            IntPoint linePoint2)
        {
            float d;
        ...
        ///
        public static IntPoint GetFurthestPointFromLine(IEnumerable<IntPoint> cloud, IntPoint linePoint1,
            IntPoint linePoint2, out float distance)
        {
